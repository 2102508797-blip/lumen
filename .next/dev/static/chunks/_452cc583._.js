...
function DashboardPage() {
    ...
    const handleAddBlock = (block)=>{
        ...
        // Show success toast
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("🎉 Time block added! You're building great habits!", {
            duration: 3000
        });
        ...
        if (newTotal === 5 || newTotal === 10 || newTotal === 20) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`🏆 Amazing! You've created ${newTotal} time blocks!`, {
                duration: 4000
            });
        }
    };
    const handleDeleteBlock = (id)=>{
        ...
        setStatsKey((prev)=>prev + 1);
        // Show toast
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`✓ "${blockToDelete?.title || 'Block'}" removed from your schedule`, {
            duration: 2500
        });
    };
    const handleUpdateBlock = (id, updates)=>{
        ...
        setStatsKey((prev)=>prev + 1);
        // Show success toast
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("✓ Time block updated successfully!", {
            duration: 2500
        });
    };
    const previousMonth = ()=>{
...
_s(DashboardPage, "EANfQYPcSj25fDarbWT9hSFP09s=");
_c = DashboardPage;
/* ---------- helpers ---------- */ function isSameDay(a, b) {
    return a.getFullYear() === b.getFullYear() && a.getMonth() === b.getMonth() && a.getDate() === b.getDate();
}
